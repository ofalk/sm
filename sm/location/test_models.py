...
class Tester(TestCase):
    ...
    def test_name___str___wo_country(self):
        self.assertEqual('%s' % self.testitem.name, self.teststring,
                         'name not correct')

    def test___str___w_country(self):
        self.testitem.country = self.country
        self.assertEqual("%s" % self.testitem,
                         '%s / %s' % (self.teststring, self.country),
                         'name not correct')

    def test___str___w_nonexistant_country(self):
        self.testitem.country = self.teststring
        self.assertEqual("%s" % self.testitem,
                         '%s / %s' % (self.teststring, self.teststring),
                         'name not correct')
