...
class OperatingsystemTestCase(unittest.TestCase):
    ...
    def test_07_get_rhel_7_by_nat_key(self):
        from operatingsystem.models import Operatingsystem as Model
        os = Model.objects.get_by_natural_key('RHEL 7')
        self.assertIsInstance(os, Model,
                              'object not a Operatingsystem model!?')

    def test_08_get_rhel_7_by_nat_key2(self):
        from operatingsystem.models import Operatingsystem as Model
        os = Model.objects.get_by_natural_key('Red Hat 7.0')
        self.assertIsInstance(os, Model,
                              'object not a Operatingsystem model!?')

    def test_09_get_rhel_7_by_nat_key3(self):
        from operatingsystem.models import Operatingsystem as Model
        os = Model.objects.get_by_natural_key('Red Hat7')
        self.assertIsInstance(os, Model,
                              'object not a Operatingsystem model!?')
    ...
    def test_10_get_or_create_sles_10(self):
        ...
        Model.objects.get_or_create(vendor=vendor, version='10.0')

    def test_11_get_sles_10_by_nat_key(self):
        from operatingsystem.models import Operatingsystem as Model
        os = Model.objects.get_by_natural_key('SLES 10.0')
        self.assertIsInstance(os, Model,
                              'object not a Operatingsystem model!?')
    ...
    def test_16_get_absolute_url(self):
        from operatingsystem.models import Operatingsystem as Model
        item = Model.objects.get(version='123XXX')
    ...
    def tearDownClass():
        ...
        from operatingsystem.models import Operatingsystem as Model
        try:
            osmod = Model.objects.get(version="123XXX")
            osmod.delete()
