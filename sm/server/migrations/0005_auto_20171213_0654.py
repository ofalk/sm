...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='model',
            name='domain',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='server_set', related_query_name='server', to='domain.Model'),
        ),
        migrations.AlterField(
            model_name='model',
            name='location',
        ...
        migrations.AlterField(
            model_name='model',
            name='patchtime',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='server_set', related_query_name='server', to='patchtime.Model'),
        ),
        migrations.AlterField(
            model_name='model',
            name='servermodel',
